...
/*
 * Various methods for adding specific devices to the device list after instantiating
 * them. 
 *
 * TODO: Assert statements to check for incorrect string length inputs (must be 1-2 character
 * identifiers), non-unique identifiers, and NULL function pointers. Particle does not currently
 * support error handling with assert statements, error raising, etc.
 */
...
/*
 * Connect to user's Particle account and expose the device list and
 * parse_cmd function to the cloud.
 */
void coral_setup() {
 ...
 *
 * Currently the device list does not update after initialization
 */
...
/*
 * Return a specific device instance given an identifier.
 */
 ...
 *
 * OUTPUT: -1 for error, 1-4 for different device, or the sensor value 
 */
